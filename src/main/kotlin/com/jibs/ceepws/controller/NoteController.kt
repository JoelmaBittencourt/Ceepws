...
class NoteController {
    ...
    //    @GetMapping
//    fun list(): List<NoteModel?> {
//        return noteRepository.findAll().toList()//Como o findAll() devolve um Iterable, precisamos converter para uma lista, pois o retorno é uma lista de notas, por isso chamamos também a função toList().
//    }
    @PostMapping
...
//    }
//    @PostMapping
//    fun add(@RequestBody note: NoteModel): NoteModel {//A função save() devolve o próprio objeto que foi salvo na base de dados, a diferença é que ele é devolvido com o mesmo id que foi salvo no banco de dados.
